...
void forward_logistic_layer(const layer l, network net)
{
    ...
    if(net.truthn){
        logistic_x_ent_cpu(l.batch*l.inputs, l.output, net.truthn, l.delta, l.loss);
...
void forward_logistic_layer_gpu(const layer l, network net)
{
    ...
    if(net.truthn){
        logistic_x_ent_gpu(l.batch*l.inputs, l.output_gpu, net.truthn_gpu, l.delta_gpu, l.loss_gpu);
