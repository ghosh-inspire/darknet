...
void forward_softmax_layer(const softmax_layer l, network net)
{
    ...
    if(net.truthn && !l.noloss){
        softmax_x_ent_cpu(l.batch*l.inputs, l.output, net.truthn, l.delta, l.loss);
...
void forward_softmax_layer_gpu(const softmax_layer l, network net)
{
    ...
    if(net.truthn && !l.noloss){
        softmax_x_ent_gpu(l.batch*l.inputs, l.output_gpu, net.truthn_gpu, l.delta_gpu, l.loss_gpu);
        if(l.softmax_tree){
            mask_gpu(l.batch*l.inputs, l.delta_gpu, SECRET_NUM, net.truthn_gpu, 0);
            mask_gpu(l.batch*l.inputs, l.loss_gpu, SECRET_NUM, net.truthn_gpu, 0);
        }
